...
static void Loop()
{
    ...
    {
		std::cout << "Message Type: ECHO" << std::endl;
	...
	{
		//if(msg.type == app::CliMessage::Type::EMPTY)
		//	std::cout << "Message Type: EMPTY" << std::endl;
        return;
	}
	...
	std::cout << "Message Type: COMMAND" << std::endl;
    ReceiveCommand(msg);
}
...
int main(int argc, char **argv)
{
    ...
    std::cout << "Starting " << cons::Name << std::endl;
	...
	std::cout << "gNB name: " << g_refConfig->name << std::endl;
	/*for	(auto i = g_refConfig->gnbAssocConfigs.begin(); i != g_refConfig->gnbAssocConfigs.end(); ++i)
	{
		std::cout << "Associated address: " << i->address << " Port: " << i->port << std::endl;
	}*/
