...
asn_TYPE_member_t asn_MBR_UEAggregateMaximumBitRate_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UEAggregateMaximumBitRate, dl_UE_AMBR),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UEAggregateMaximumBitRate, ul_UE_AMBR),
	...
	{ ATF_POINTER, 1, offsetof(struct UEAggregateMaximumBitRate, iE_Extension),
