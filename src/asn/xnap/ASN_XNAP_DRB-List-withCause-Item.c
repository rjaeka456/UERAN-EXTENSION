...
asn_TYPE_member_t asn_MBR_DRB_List_withCause_Item_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DRB_List_withCause_Item, drb_id),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DRB_List_withCause_Item, cause),
	...
	{ ATF_POINTER, 2, offsetof(struct DRB_List_withCause_Item, rLC_Mode),
	...
	{ ATF_POINTER, 1, offsetof(struct DRB_List_withCause_Item, iE_Extension),
...
asn_SEQUENCE_specifics_t asn_SPC_DRB_List_withCause_Item_specs_1 = {
	sizeof(struct DRB_List_withCause_Item),
	offsetof(struct DRB_List_withCause_Item, _asn_ctx),
