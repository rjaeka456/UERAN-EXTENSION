...
asn_TYPE_member_t asn_MBR_NotificationControlIndication_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NotificationControlIndication, protocolIEs),
...
asn_SEQUENCE_specifics_t asn_SPC_NotificationControlIndication_specs_1 = {
	sizeof(struct NotificationControlIndication),
	offsetof(struct NotificationControlIndication, _asn_ctx),
