...
static const int asn_MAP_SpecialSubframeInfo_E_UTRA_oms_1[] = { 3 };
static const ber_tlv_tag_t asn_DEF_SpecialSubframeInfo_E_UTRA_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_SpecialSubframeInfo_E_UTRA_tag2el_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_SpecialSubframeInfo_E_UTRA = {
	"SpecialSubframeInfo-E-UTRA",
	"SpecialSubframeInfo-E-UTRA",
	&asn_OP_SEQUENCE,
	asn_DEF_SpecialSubframeInfo_E_UTRA_tags_1,
	sizeof(asn_DEF_SpecialSubframeInfo_E_UTRA_tags_1)
		/sizeof(asn_DEF_SpecialSubframeInfo_E_UTRA_tags_1[0]), /* 1 */
	asn_DEF_SpecialSubframeInfo_E_UTRA_tags_1,	/* Same as above */
	sizeof(asn_DEF_SpecialSubframeInfo_E_UTRA_tags_1)
		/sizeof(asn_DEF_SpecialSubframeInfo_E_UTRA_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_SpecialSubframeInfo_E_UTRA_1,
	4,	/* Elements count */
	&asn_SPC_SpecialSubframeInfo_E_UTRA_specs_1	/* Additional specs */
};
