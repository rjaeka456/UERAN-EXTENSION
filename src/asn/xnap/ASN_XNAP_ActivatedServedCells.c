...
#include "ActivatedServedCells.h"
...
static asn_per_constraints_t asn_PER_type_ActivatedServedCells_constr_1 CC_NOTUSED = {
...
static asn_SET_OF_specifics_t asn_SPC_nr_cells_specs_2 = {
	sizeof(struct ActivatedServedCells__nr_cells),
	offsetof(struct ActivatedServedCells__nr_cells, _asn_ctx),
...
static asn_SET_OF_specifics_t asn_SPC_e_utra_cells_specs_4 = {
	sizeof(struct ActivatedServedCells__e_utra_cells),
	offsetof(struct ActivatedServedCells__e_utra_cells, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
...
static asn_TYPE_member_t asn_MBR_ActivatedServedCells_1[] = {
	{ ATF_POINTER, 0, offsetof(struct ActivatedServedCells, choice.nr_cells),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_nr_cells_2,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct ActivatedServedCells, choice.e_utra_cells),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct ActivatedServedCells, choice.choice_extension),
...
static const asn_TYPE_tag2member_t asn_MAP_ActivatedServedCells_tag2el_1[] = {
...
static asn_CHOICE_specifics_t asn_SPC_ActivatedServedCells_specs_1 = {
	sizeof(struct ActivatedServedCells),
	offsetof(struct ActivatedServedCells, _asn_ctx),
	offsetof(struct ActivatedServedCells, present),
	sizeof(((struct ActivatedServedCells *)0)->present),
	asn_MAP_ActivatedServedCells_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
asn_TYPE_descriptor_t asn_DEF_ActivatedServedCells = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_ActivatedServedCells_constr_1, CHOICE_constraint },
	asn_MBR_ActivatedServedCells_1,
	3,	/* Elements count */
	&asn_SPC_ActivatedServedCells_specs_1	/* Additional specs */
};
