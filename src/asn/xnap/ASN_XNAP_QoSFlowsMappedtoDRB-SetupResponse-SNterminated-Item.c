...
asn_TYPE_member_t asn_MBR_QoSFlowsMappedtoDRB_SetupResponse_SNterminated_Item_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct QoSFlowsMappedtoDRB_SetupResponse_SNterminated_Item, qoSFlowIdentifier),
	...
	{ ATF_POINTER, 3, offsetof(struct QoSFlowsMappedtoDRB_SetupResponse_SNterminated_Item, mCGRequestedGBRQoSFlowInfo),
	...
	{ ATF_POINTER, 2, offsetof(struct QoSFlowsMappedtoDRB_SetupResponse_SNterminated_Item, qosFlowMappingIndication),
	...
	{ ATF_POINTER, 1, offsetof(struct QoSFlowsMappedtoDRB_SetupResponse_SNterminated_Item, iE_Extensions),
...
asn_SEQUENCE_specifics_t asn_SPC_QoSFlowsMappedtoDRB_SetupResponse_SNterminated_Item_specs_1 = {
	sizeof(struct QoSFlowsMappedtoDRB_SetupResponse_SNterminated_Item),
	offsetof(struct QoSFlowsMappedtoDRB_SetupResponse_SNterminated_Item, _asn_ctx),
