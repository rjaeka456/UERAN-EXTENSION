...
static const asn_TYPE_tag2member_t asn_MAP_NeighbourInformation_NR_ModeInfo_tag2el_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_NeighbourInformation_NR_ModeInfo = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_NeighbourInformation_NR_ModeInfo_constr_1, CHOICE_constraint },
	asn_MBR_NeighbourInformation_NR_ModeInfo_1,
	3,	/* Elements count */
	&asn_SPC_NeighbourInformation_NR_ModeInfo_specs_1	/* Additional specs */
};
