...
asn_TYPE_member_t asn_MBR_NeighbourInformation_NR_Item_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NeighbourInformation_NR_Item, nr_PCI),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighbourInformation_NR_Item, nr_cgi),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighbourInformation_NR_Item, tac),
	...
	{ ATF_POINTER, 1, offsetof(struct NeighbourInformation_NR_Item, ranac),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighbourInformation_NR_Item, nr_mode_info),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighbourInformation_NR_Item, connectivitySupport),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighbourInformation_NR_Item, measurementTimingConfiguration),
	...
	{ ATF_POINTER, 1, offsetof(struct NeighbourInformation_NR_Item, iE_Extensions),
...
asn_SEQUENCE_specifics_t asn_SPC_NeighbourInformation_NR_Item_specs_1 = {
	sizeof(struct NeighbourInformation_NR_Item),
	offsetof(struct NeighbourInformation_NR_Item, _asn_ctx),
