...
static int
memb_amf_set_id_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static int
memb_amf_pointer_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static asn_per_constraints_t asn_PER_memb_amf_region_id_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  8,  8 }	/* (SIZE(8..8)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_amf_set_id_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  10,  10 }	/* (SIZE(10..10)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_amf_pointer_constr_5 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
static asn_TYPE_member_t asn_MBR_GUAMI_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_GUAMI, amf_region_id),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_amf_region_id_constr_3,  memb_amf_region_id_constraint_1 },
		0, 0, /* No default value */
		"amf-region-id"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_GUAMI, amf_set_id),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_amf_set_id_constr_4,  memb_amf_set_id_constraint_1 },
		0, 0, /* No default value */
		"amf-set-id"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_GUAMI, amf_pointer),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_amf_pointer_constr_5,  memb_amf_pointer_constraint_1 },
		0, 0, /* No default value */
		"amf-pointer"
		},
