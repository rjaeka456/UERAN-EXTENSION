...
static asn_per_constraints_t asn_PER_memb_prach_FreqOffset_constr_8 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7,  0,  94 }	/* (0..94) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_prach_ConfigIndex_constr_9 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_highSpeedFlag_4 = {
	...
	{ 0, &asn_PER_type_highSpeedFlag_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_ASN_XNAP_E_UTRAPRACHConfiguration_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_E_UTRAPRACHConfiguration, prach_FreqOffset),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_prach_FreqOffset_constr_8,  memb_prach_FreqOffset_constraint_1 },
		0, 0, /* No default value */
		"prach-FreqOffset"
		},
	{ ATF_POINTER, 2, offsetof(struct ASN_XNAP_E_UTRAPRACHConfiguration, prach_ConfigIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_prach_ConfigIndex_constr_9,  memb_prach_ConfigIndex_constraint_1 },
		0, 0, /* No default value */
		"prach-ConfigIndex"
		},
