...
asn_TYPE_member_t asn_MBR_QoSFlowsActivityNotifyItem_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct QoSFlowsActivityNotifyItem, qosFlowIdentifier),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct QoSFlowsActivityNotifyItem, pduSessionLevelUPactivityreport),
	...
	{ ATF_POINTER, 1, offsetof(struct QoSFlowsActivityNotifyItem, iE_Extensions),
...
asn_SEQUENCE_specifics_t asn_SPC_QoSFlowsActivityNotifyItem_specs_1 = {
	sizeof(struct QoSFlowsActivityNotifyItem),
	offsetof(struct QoSFlowsActivityNotifyItem, _asn_ctx),
