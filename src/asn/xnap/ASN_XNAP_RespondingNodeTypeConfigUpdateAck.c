...
static const asn_TYPE_tag2member_t asn_MAP_RespondingNodeTypeConfigUpdateAck_tag2el_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_RespondingNodeTypeConfigUpdateAck = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_RespondingNodeTypeConfigUpdateAck_constr_1, CHOICE_constraint },
	asn_MBR_RespondingNodeTypeConfigUpdateAck_1,
	3,	/* Elements count */
	&asn_SPC_RespondingNodeTypeConfigUpdateAck_specs_1	/* Additional specs */
};
