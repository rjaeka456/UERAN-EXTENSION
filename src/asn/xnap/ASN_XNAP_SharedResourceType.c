...
asn_TYPE_member_t asn_MBR_SharedResourceType_1[] = {
	{ ATF_POINTER, 0, offsetof(struct SharedResourceType, choice.ul_onlySharing),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SharedResourceType_UL_OnlySharing,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"ul-onlySharing"
		},
	{ ATF_POINTER, 0, offsetof(struct SharedResourceType, choice.ul_and_dl_Sharing),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SharedResourceType_ULDL_Sharing,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"ul-and-dl-Sharing"
		},
	{ ATF_POINTER, 0, offsetof(struct SharedResourceType, choice.choice_extension),
