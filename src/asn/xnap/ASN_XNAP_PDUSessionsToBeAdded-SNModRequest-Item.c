...
asn_TYPE_member_t asn_MBR_PDUSessionsToBeAdded_SNModRequest_Item_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PDUSessionsToBeAdded_SNModRequest_Item, pduSessionId),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PDUSessionsToBeAdded_SNModRequest_Item, s_NSSAI),
	...
	{ ATF_POINTER, 4, offsetof(struct PDUSessionsToBeAdded_SNModRequest_Item, sN_PDUSessionAMBR),
	...
	{ ATF_POINTER, 3, offsetof(struct PDUSessionsToBeAdded_SNModRequest_Item, sn_terminated),
	...
	{ ATF_POINTER, 2, offsetof(struct PDUSessionsToBeAdded_SNModRequest_Item, mn_terminated),
	...
	{ ATF_POINTER, 1, offsetof(struct PDUSessionsToBeAdded_SNModRequest_Item, iE_Extension),
...
asn_SEQUENCE_specifics_t asn_SPC_PDUSessionsToBeAdded_SNModRequest_Item_specs_1 = {
	sizeof(struct PDUSessionsToBeAdded_SNModRequest_Item),
	offsetof(struct PDUSessionsToBeAdded_SNModRequest_Item, _asn_ctx),
