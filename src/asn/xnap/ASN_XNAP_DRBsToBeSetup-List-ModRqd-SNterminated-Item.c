...
static const int asn_MAP_DRBsToBeSetup_List_ModRqd_SNterminated_Item_oms_1[] = { 1, 4, 5, 6, 9 };
static const ber_tlv_tag_t asn_DEF_DRBsToBeSetup_List_ModRqd_SNterminated_Item_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DRBsToBeSetup_List_ModRqd_SNterminated_Item_tag2el_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_DRBsToBeSetup_List_ModRqd_SNterminated_Item = {
	"DRBsToBeSetup-List-ModRqd-SNterminated-Item",
	"DRBsToBeSetup-List-ModRqd-SNterminated-Item",
	&asn_OP_SEQUENCE,
	asn_DEF_DRBsToBeSetup_List_ModRqd_SNterminated_Item_tags_1,
	sizeof(asn_DEF_DRBsToBeSetup_List_ModRqd_SNterminated_Item_tags_1)
		/sizeof(asn_DEF_DRBsToBeSetup_List_ModRqd_SNterminated_Item_tags_1[0]), /* 1 */
	asn_DEF_DRBsToBeSetup_List_ModRqd_SNterminated_Item_tags_1,	/* Same as above */
	sizeof(asn_DEF_DRBsToBeSetup_List_ModRqd_SNterminated_Item_tags_1)
		/sizeof(asn_DEF_DRBsToBeSetup_List_ModRqd_SNterminated_Item_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_DRBsToBeSetup_List_ModRqd_SNterminated_Item_1,
	10,	/* Elements count */
	&asn_SPC_DRBsToBeSetup_List_ModRqd_SNterminated_Item_specs_1	/* Additional specs */
};
