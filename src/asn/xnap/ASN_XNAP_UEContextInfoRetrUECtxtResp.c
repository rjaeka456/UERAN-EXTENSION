...
static const int asn_MAP_UEContextInfoRetrUECtxtResp_oms_1[] = { 7, 8, 9 };
static const ber_tlv_tag_t asn_DEF_UEContextInfoRetrUECtxtResp_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UEContextInfoRetrUECtxtResp_tag2el_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_UEContextInfoRetrUECtxtResp = {
	"UEContextInfoRetrUECtxtResp",
	"UEContextInfoRetrUECtxtResp",
	&asn_OP_SEQUENCE,
	asn_DEF_UEContextInfoRetrUECtxtResp_tags_1,
	sizeof(asn_DEF_UEContextInfoRetrUECtxtResp_tags_1)
		/sizeof(asn_DEF_UEContextInfoRetrUECtxtResp_tags_1[0]), /* 1 */
	asn_DEF_UEContextInfoRetrUECtxtResp_tags_1,	/* Same as above */
	sizeof(asn_DEF_UEContextInfoRetrUECtxtResp_tags_1)
		/sizeof(asn_DEF_UEContextInfoRetrUECtxtResp_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_UEContextInfoRetrUECtxtResp_1,
	10,	/* Elements count */
	&asn_SPC_UEContextInfoRetrUECtxtResp_specs_1	/* Additional specs */
};
