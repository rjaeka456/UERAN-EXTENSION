...
asn_TYPE_member_t asn_MBR_NG_RAN_Cell_Identity_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NG_RAN_Cell_Identity, choice.nr),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NG_RAN_Cell_Identity, choice.e_utra),
	...
	{ ATF_POINTER, 0, offsetof(struct NG_RAN_Cell_Identity, choice.choice_extension),
...
asn_CHOICE_specifics_t asn_SPC_NG_RAN_Cell_Identity_specs_1 = {
	sizeof(struct NG_RAN_Cell_Identity),
	offsetof(struct NG_RAN_Cell_Identity, _asn_ctx),
	offsetof(struct NG_RAN_Cell_Identity, present),
	sizeof(((struct NG_RAN_Cell_Identity *)0)->present),
