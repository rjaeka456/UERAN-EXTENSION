...
static const int asn_MAP_UEContextInfo_SNModRequest_oms_1[] = { 0, 1, 2, 3, 4, 5, 6, 7, 8 };
static const ber_tlv_tag_t asn_DEF_UEContextInfo_SNModRequest_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UEContextInfo_SNModRequest_tag2el_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_UEContextInfo_SNModRequest = {
	"UEContextInfo-SNModRequest",
	"UEContextInfo-SNModRequest",
	&asn_OP_SEQUENCE,
	asn_DEF_UEContextInfo_SNModRequest_tags_1,
	sizeof(asn_DEF_UEContextInfo_SNModRequest_tags_1)
		/sizeof(asn_DEF_UEContextInfo_SNModRequest_tags_1[0]), /* 1 */
	asn_DEF_UEContextInfo_SNModRequest_tags_1,	/* Same as above */
	sizeof(asn_DEF_UEContextInfo_SNModRequest_tags_1)
		/sizeof(asn_DEF_UEContextInfo_SNModRequest_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_UEContextInfo_SNModRequest_1,
	9,	/* Elements count */
	&asn_SPC_UEContextInfo_SNModRequest_specs_1	/* Additional specs */
};
