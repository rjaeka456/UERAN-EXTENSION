 ...
 */
static asn_per_constraints_t asn_PER_type_additionalQoSflowInfo_constr_6 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  0,  0,  0,  0 }	/* (0..0,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_additionalQoSflowInfo_value2enum_6[] = {
	{ 0,	11,	"more-likely" }
	/* This list is extensible */
};
static const unsigned int asn_MAP_additionalQoSflowInfo_enum2value_6[] = {
	0	/* more-likely(0) */
	/* This list is extensible */
};
static const asn_INTEGER_specifics_t asn_SPC_additionalQoSflowInfo_specs_6 = {
	asn_MAP_additionalQoSflowInfo_value2enum_6,	/* "tag" => N; sorted by tag */
	asn_MAP_additionalQoSflowInfo_enum2value_6,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_additionalQoSflowInfo_tags_6[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_additionalQoSflowInfo_6 = {
	"additionalQoSflowInfo",
	"additionalQoSflowInfo",
	&asn_OP_NativeEnumerated,
	asn_DEF_additionalQoSflowInfo_tags_6,
	sizeof(asn_DEF_additionalQoSflowInfo_tags_6)
		/sizeof(asn_DEF_additionalQoSflowInfo_tags_6[0]) - 1, /* 1 */
	asn_DEF_additionalQoSflowInfo_tags_6,	/* Same as above */
	sizeof(asn_DEF_additionalQoSflowInfo_tags_6)
		/sizeof(asn_DEF_additionalQoSflowInfo_tags_6[0]), /* 2 */
	{ 0, &asn_PER_type_additionalQoSflowInfo_constr_6, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_additionalQoSflowInfo_specs_6	/* Additional specs */
};
...
static const asn_TYPE_tag2member_t asn_MAP_QoSFlowLevelQoSParameters_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* relectiveQoS */
