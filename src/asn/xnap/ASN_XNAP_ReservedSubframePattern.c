...
static asn_per_constraints_t asn_PER_type_subframeType_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  1,  1,  0,  1 }	/* (0..1,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_reservedSubframePattern_constr_6 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 8,  8,  10,  160 }	/* (SIZE(10..160)) */,
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_subframeType_value2enum_2[] = {
	{ 0,	5,	"mbsfn" },
	{ 1,	9,	"non-mbsfn" }
	/* This list is extensible */
};
static const unsigned int asn_MAP_subframeType_enum2value_2[] = {
	0,	/* mbsfn(0) */
	1	/* non-mbsfn(1) */
	/* This list is extensible */
};
static const asn_INTEGER_specifics_t asn_SPC_subframeType_specs_2 = {
	asn_MAP_subframeType_value2enum_2,	/* "tag" => N; sorted by tag */
	asn_MAP_subframeType_enum2value_2,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_subframeType_tags_2[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_subframeType_2 = {
	"subframeType",
	"subframeType",
	&asn_OP_NativeEnumerated,
	asn_DEF_subframeType_tags_2,
	sizeof(asn_DEF_subframeType_tags_2)
		/sizeof(asn_DEF_subframeType_tags_2[0]) - 1, /* 1 */
	asn_DEF_subframeType_tags_2,	/* Same as above */
	sizeof(asn_DEF_subframeType_tags_2)
		/sizeof(asn_DEF_subframeType_tags_2[0]), /* 2 */
	{ 0, &asn_PER_type_subframeType_constr_2, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_subframeType_specs_2	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_ReservedSubframePattern_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ReservedSubframePattern, reservedSubframePattern),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_reservedSubframePattern_constr_6,  memb_reservedSubframePattern_constraint_1 },
		0, 0, /* No default value */
		"reservedSubframePattern"
		},
	{ ATF_POINTER, 2, offsetof(struct ReservedSubframePattern, mbsfnControlRegionLength),
	...
	{ ATF_POINTER, 1, offsetof(struct ReservedSubframePattern, iE_Extension),
...
static const int asn_MAP_ReservedSubframePattern_oms_1[] = { 2, 3 };
