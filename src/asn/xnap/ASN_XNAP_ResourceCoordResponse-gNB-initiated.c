...
static asn_per_constraints_t asn_PER_type_listofNRCells_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 14,  14,  1,  16384 }	/* (SIZE(1..16384)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_listofNRCells_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 14,  14,  1,  16384 }	/* (SIZE(1..16384)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_listofNRCells_4[] = {
	{ ATF_POINTER, 0, 0,
...
static const ber_tlv_tag_t asn_DEF_listofNRCells_tags_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_listofNRCells_4 = {
	"listofNRCells",
	"listofNRCells",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_listofNRCells_tags_4,
	sizeof(asn_DEF_listofNRCells_tags_4)
		/sizeof(asn_DEF_listofNRCells_tags_4[0]) - 1, /* 1 */
	asn_DEF_listofNRCells_tags_4,	/* Same as above */
	sizeof(asn_DEF_listofNRCells_tags_4)
		/sizeof(asn_DEF_listofNRCells_tags_4[0]), /* 2 */
	{ 0, &asn_PER_type_listofNRCells_constr_4, SEQUENCE_OF_constraint },
	asn_MBR_listofNRCells_4,
	1,	/* Single element */
	&asn_SPC_listofNRCells_specs_4	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_ResourceCoordResponse_gNB_initiated_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct ASN_XNAP_ResourceCoordResponse_gNB_initiated, listofNRCells),
		...
		0,
		{ 0, &asn_PER_memb_listofNRCells_constr_4,  memb_listofNRCells_constraint_1 },
		0, 0, /* No default value */
		"listofNRCells"
		},
...
static const int asn_MAP_ResourceCoordResponse_gNB_initiated_oms_1[] = { 2, 3 };
static const ber_tlv_tag_t asn_DEF_ResourceCoordResponse_gNB_initiated_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ResourceCoordResponse_gNB_initiated_tag2el_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_ResourceCoordResponse_gNB_initiated = {
	"ResourceCoordResponse-gNB-initiated",
	"ResourceCoordResponse-gNB-initiated",
	&asn_OP_SEQUENCE,
	asn_DEF_ResourceCoordResponse_gNB_initiated_tags_1,
	sizeof(asn_DEF_ResourceCoordResponse_gNB_initiated_tags_1)
		/sizeof(asn_DEF_ResourceCoordResponse_gNB_initiated_tags_1[0]), /* 1 */
	asn_DEF_ResourceCoordResponse_gNB_initiated_tags_1,	/* Same as above */
	sizeof(asn_DEF_ResourceCoordResponse_gNB_initiated_tags_1)
		/sizeof(asn_DEF_ResourceCoordResponse_gNB_initiated_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_ResourceCoordResponse_gNB_initiated_1,
	4,	/* Elements count */
	&asn_SPC_ResourceCoordResponse_gNB_initiated_specs_1	/* Additional specs */
};
