...
static const int asn_MAP_PDUSessionResourceSetupInfo_SNterminated_oms_1[] = { 2, 4, 5, 6 };
static const ber_tlv_tag_t asn_DEF_PDUSessionResourceSetupInfo_SNterminated_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PDUSessionResourceSetupInfo_SNterminated_tag2el_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_PDUSessionResourceSetupInfo_SNterminated = {
	"PDUSessionResourceSetupInfo-SNterminated",
	"PDUSessionResourceSetupInfo-SNterminated",
	&asn_OP_SEQUENCE,
	asn_DEF_PDUSessionResourceSetupInfo_SNterminated_tags_1,
	sizeof(asn_DEF_PDUSessionResourceSetupInfo_SNterminated_tags_1)
		/sizeof(asn_DEF_PDUSessionResourceSetupInfo_SNterminated_tags_1[0]), /* 1 */
	asn_DEF_PDUSessionResourceSetupInfo_SNterminated_tags_1,	/* Same as above */
	sizeof(asn_DEF_PDUSessionResourceSetupInfo_SNterminated_tags_1)
		/sizeof(asn_DEF_PDUSessionResourceSetupInfo_SNterminated_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_PDUSessionResourceSetupInfo_SNterminated_1,
	7,	/* Elements count */
	&asn_SPC_PDUSessionResourceSetupInfo_SNterminated_specs_1	/* Additional specs */
};
