...
static asn_per_constraints_t asn_PER_type_broadcastPLMNs_constr_6 CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_type_bandwidthReducedSI_constr_17 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  0,  0,  0,  0 }	/* (0..0,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_broadcastPLMNs_constr_6 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  12 }	/* (SIZE(1..12)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_broadcastPLMNs_6[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_ServedCellInformation_E_UTRA_perBPLMN,
		0,
		{ 0, 0, 0 },
...
static const ber_tlv_tag_t asn_DEF_broadcastPLMNs_tags_6[] = {
...
asn_TYPE_descriptor_t asn_DEF_broadcastPLMNs_6 = {
	"broadcastPLMNs",
	"broadcastPLMNs",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_broadcastPLMNs_tags_6,
	sizeof(asn_DEF_broadcastPLMNs_tags_6)
		/sizeof(asn_DEF_broadcastPLMNs_tags_6[0]) - 1, /* 1 */
	asn_DEF_broadcastPLMNs_tags_6,	/* Same as above */
	sizeof(asn_DEF_broadcastPLMNs_tags_6)
		/sizeof(asn_DEF_broadcastPLMNs_tags_6[0]), /* 2 */
	{ 0, &asn_PER_type_broadcastPLMNs_constr_6, SEQUENCE_OF_constraint },
	asn_MBR_broadcastPLMNs_6,
	1,	/* Single element */
	&asn_SPC_broadcastPLMNs_specs_6	/* Additional specs */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_bandwidthReducedSI_value2enum_17[] = {
	{ 0,	9,	"scheduled" }
	/* This list is extensible */
};
static const unsigned int asn_MAP_bandwidthReducedSI_enum2value_17[] = {
	0	/* scheduled(0) */
	/* This list is extensible */
};
static const asn_INTEGER_specifics_t asn_SPC_bandwidthReducedSI_specs_17 = {
	asn_MAP_bandwidthReducedSI_value2enum_17,	/* "tag" => N; sorted by tag */
	asn_MAP_bandwidthReducedSI_enum2value_17,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_bandwidthReducedSI_tags_17[] = {
	(ASN_TAG_CLASS_CONTEXT | (11 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_bandwidthReducedSI_17 = {
	"bandwidthReducedSI",
	"bandwidthReducedSI",
	&asn_OP_NativeEnumerated,
	asn_DEF_bandwidthReducedSI_tags_17,
	sizeof(asn_DEF_bandwidthReducedSI_tags_17)
		/sizeof(asn_DEF_bandwidthReducedSI_tags_17[0]) - 1, /* 1 */
	asn_DEF_bandwidthReducedSI_tags_17,	/* Same as above */
	sizeof(asn_DEF_bandwidthReducedSI_tags_17)
		/sizeof(asn_DEF_bandwidthReducedSI_tags_17[0]), /* 2 */
	{ 0, &asn_PER_type_bandwidthReducedSI_constr_17, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_bandwidthReducedSI_specs_17	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_ServedCellInformation_E_UTRA_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ServedCellInformation_E_UTRA, broadcastPLMNs),
		...
		0,
		{ 0, &asn_PER_memb_broadcastPLMNs_constr_6,  memb_broadcastPLMNs_constraint_1 },
		0, 0, /* No default value */
		"broadcastPLMNs"
		},
...
static const int asn_MAP_ServedCellInformation_E_UTRA_oms_1[] = { 3, 6, 7, 8, 9, 10, 11, 12, 13 };
static const ber_tlv_tag_t asn_DEF_ServedCellInformation_E_UTRA_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ServedCellInformation_E_UTRA_tag2el_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_ServedCellInformation_E_UTRA = {
	"ServedCellInformation-E-UTRA",
	"ServedCellInformation-E-UTRA",
	&asn_OP_SEQUENCE,
	asn_DEF_ServedCellInformation_E_UTRA_tags_1,
	sizeof(asn_DEF_ServedCellInformation_E_UTRA_tags_1)
		/sizeof(asn_DEF_ServedCellInformation_E_UTRA_tags_1[0]), /* 1 */
	asn_DEF_ServedCellInformation_E_UTRA_tags_1,	/* Same as above */
	sizeof(asn_DEF_ServedCellInformation_E_UTRA_tags_1)
		/sizeof(asn_DEF_ServedCellInformation_E_UTRA_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_ServedCellInformation_E_UTRA_1,
	14,	/* Elements count */
	&asn_SPC_ServedCellInformation_E_UTRA_specs_1	/* Additional specs */
};
