...
typedef struct ResourceCoordResponse_ng_eNB_initiated {
	DataTrafficResourceIndication_t	 dataTrafficResourceIndication;
	SpectrumSharingGroupID_t	 spectrumSharingGroupID;
	struct ResourceCoordResponse_ng_eNB_initiated__listofE_UTRACells {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ResourceCoordResponse_ng_eNB_initiated_t;
